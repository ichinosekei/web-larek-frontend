...
// нейминг
// класс Modal отвечает за работу модального окна в веб-приложении.
...
//set locked(value: boolean) Управляет блокировкой основного контента страницы (например, прокрутки) при активном модальном окне.
